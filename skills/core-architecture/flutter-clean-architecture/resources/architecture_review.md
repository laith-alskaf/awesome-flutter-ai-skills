...
- [ ] Run `dart run .agents/tools/verify_architecture.dart` — must report **zero** domain or data boundary violations.
...
**Verification Tool:** `dart run .agents/tools/verify_architecture.dart [path_to_project_root]`
